    ...
    def reschedule_appointment(
        ...
        if not availability.empty:
            ...
            appointments_df.to_excel(
                "./Appointment/doctor_appointments.xlsx", index=False
            )
...
def update_availability_csv(original_date, desired_date, desired_time, patient_id):
